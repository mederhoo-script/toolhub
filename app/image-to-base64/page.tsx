    ...
    >
      ...
      <section className="mt-10">
        ...
        <p className="text-neutral-600 leading-relaxed mt-3">
          Free Image Tool Hub uses the browser&apos;s FileReader API to read the selected image and produce a Base64 data URL. The resulting string follows the format <code>data:[mimeType];base64,[data]</code> and is ready to paste directly into code. The entire encoding process happens locally — no data is transmitted to any server.
        </p>
        <p className="text-neutral-600 leading-relaxed mt-3">
